import "../scss/components/Support.scss";

function Support() {
  return (
    <section className="supportContainer">
        <h1 className="supportContainer__title">Support</h1>
        <div className="supportContainer__titleBottomLine"></div>
        <h3 className="supportContainer__subtitle">This is how you can contribute</h3>
